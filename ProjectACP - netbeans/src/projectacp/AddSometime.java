...
public class AddSometime extends javax.swing.JFrame {
    ...
    public void saveDataToFile(String a){
        try{
            Path file = Paths.get("D:\\sometimedata.txt");
    ...
    public int check(){
        String check = time.getText().trim();
        String checkI = date.getText().trim();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (event.getText().isEmpty() || time.getText().isEmpty() || date.getText().isEmpty()){ 
            ...
            fileToArray();
            if (check() == 0){
                JOptionPane.showMessageDialog(null,doSometime.get(indexSometime));
                event.setText("");
                time.setText("");
                date.setText("");
            } else{
